//
//  NGAlarmsTableTableViewController.m
//  OneTapAlarm
//
//  Created by NG on 30/12/15.
...
@implementation NGAlarmsTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    NGClockView *clock = (NGClockView *)[cell viewWithTag:1];
    [clock setRadius:0 delegate:nil];
    return cell;
}
